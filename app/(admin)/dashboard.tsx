      ...
      >
        <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
          <View style={styles.heroCard}>
            ...
            <Text style={styles.heroTitle}>{MOCK_CLINIC.name}</Text>
            <Text style={styles.heroSubtitle}>
              Acompanhe rapidamente os principais numeros operacionais da clinica.
            </Text>
          ...
          <View style={styles.metricsGrid}>
            ...
            <View style={styles.metricCard}>
              <View style={[styles.metricIconBox, { backgroundColor: BLUE_LIGHT }]}>
                <Ionicons name="checkmark-circle-outline" size={20} color="#2d6cdf" />
              </View>
            ...
            <View style={styles.metricCard}>
              <View style={[styles.metricIconBox, { backgroundColor: RED_LIGHT }]}>
                <Ionicons name="close-circle-outline" size={20} color="#d95c5c" />
              </View>
              <Text style={styles.metricValue}>{stats.canceledAppointments}</Text>
            ...
            <View style={styles.metricCard}>
              ...
              <Text style={styles.metricValue}>{MOCK_CLINIC.activePatients}</Text>
            ...
            <View style={styles.metricCard}>
              ...
              <Text style={styles.metricValue}>{MOCK_CLINIC.activePsychologists}</Text>
          ...
          <View style={styles.clinicCard}>
            <InfoRow icon="business-outline" label="Nome da clinica" value={MOCK_CLINIC.name} />
            <View style={styles.divider} />
            <InfoRow icon="document-text-outline" label="CNPJ" value={MOCK_CLINIC.cnpj} />
            <View style={styles.divider} />
            <InfoRow icon="call-outline" label="Telefone" value={MOCK_CLINIC.phone} />
            <View style={styles.divider} />
            <InfoRow icon="mail-outline" label="E-mail" value={MOCK_CLINIC.email} />
            <View style={styles.divider} />
            <InfoRow
          ...
          <View style={styles.summaryCard}>
            <View style={styles.summaryRow}>
              ...
              <Text style={styles.summaryValue}>{stats.completedAppointments}</Text>
            </View>
            <View style={styles.summaryRow}>
              <Text style={styles.summaryLabel}>Consultas canceladas</Text>
              <Text style={styles.summaryValue}>{stats.canceledAppointments}</Text>
            </View>
            <View style={styles.summaryRow}>
              <Text style={styles.summaryLabel}>Pacientes em acompanhamento</Text>
              <Text style={styles.summaryValue}>{MOCK_CLINIC.activePatients}</Text>
            </View>
            <View style={styles.summaryRow}>
              <Text style={styles.summaryLabel}>Psicologos disponiveis</Text>
              <Text style={styles.summaryValue}>{MOCK_CLINIC.activePsychologists}</Text>
            </View>
          </View>
        </Animated.View>
      </ScrollView>

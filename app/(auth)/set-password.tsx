...
export default function SetPasswordScreen() {
  ...
  const validate = () => {
    ...
    if (!uid || !token) {
      nextErrors.link = "Convite inválido ou incompleto. Solicite um novo convite.";
    }
    if (!password) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    const result = await confirmInvite({ uid, token, password });

    if (result.ok) {
      setSuccess(true);
    } else {
      setApiError(result.error || "Não foi possível confirmar o convite.");
    }
    setLoading(false);
  };
        ...
        >
          ...
          >
            ...
            <Text style={styles.headerSubtitle}>
              Defina sua senha para ativar a conta criada pela clínica
            </Text>
          </Animated.View>
            ...
            {success ? (
              <View style={styles.successBox}>
                ...
                <Text style={styles.successText}>
                  Sua senha foi definida com sucesso. Agora você já pode entrar
                  no sistema.
                </Text>
                <TouchableOpacity
              ...
              <>
                ...
                >
                  {loading ? (
                    ...
                    <Text style={styles.primaryBtnText}>Ativar conta</Text>
                  )}
                </TouchableOpacity>
